...
NAME = 'semanticbits_assessment'
DESCRIPTION = 'you would be mu, too'
URL = 'https://email.com/mu.mewstopher/semanticbits_assessment'
...
setup(
    ...
    packages=find_packages(include=['semanticbits_assessment'],
    ...
    entry_points={
        'console_scripts': [
            'semanticbits_assessment=semanticbits_assessment.cli:main',
        ]
    },
)
